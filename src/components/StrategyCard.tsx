...
const CONFIG_LABELS: Record<string, string> = {
  ...
  maxExecutionPrice: "Max Execution Price",
  ...
  maxSameSideEntriesPerWindow: "Max Same-Side / Window",
  allowSameSideStacking: "Allow Same-Side Stacking",
  chopConfidenceFloor: "Chop Confidence Floor",
  chopSizeMultiplier: "Chop Size Multiplier",
  qualityMinMultiplier: "Quality Min Multiplier",
  qualityMaxMultiplier: "Quality Max Multiplier",
  spreadPenaltyK: "Spread Penalty K",
